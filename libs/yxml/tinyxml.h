...
public:
	virtual void StreamOut (TIXML_OSTREAM *, bool = false) const = 0;
...
protected:
	...
	/*	Reads an XML name into the string provided. Returns
		...
		or 0 if p or *p are 0.
	*/
	static const char* ReadName( const char* p, TIXML_STRING* name, TiXmlEncoding encoding );

	/*	Reads text. Returns a pointer past the given end tag.
		Wickedly complex options, but it keeps the (sensitive) code in one place.
		*** Return 0 if end tag is not found.
		*** Set eof to true if data ended before end tag.
	*/
	static const char* ReadText(const char* in,              // where to start
				    ...
				    bool* eof = 0);              // Optional flag set to true if data finishes before endTag
	...
	// eof is set to true if p ended before endTag
...
*/
class YXML_API TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
public:
	...
	*/
	...
	/// Remove a node from the document. Delete it if 'del' is true
...
*/
class YXML_API TiXmlAttribute : public TiXmlBase
{
...
public:
	virtual void StreamOut( TIXML_OSTREAM * out, bool unclosed = false ) const;
...
*/
class YXML_API TiXmlAttributeSet
{
public:
	TiXmlAttributeSet();
	~TiXmlAttributeSet();
...
*/
class YXML_API TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class YXML_API TiXmlComment : public TiXmlNode
{
public:
...
*/
class YXML_API TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
...
*/
class YXML_API TiXmlDeclaration : public TiXmlNode
{
public:
...
*/
class YXML_API TiXmlUnknown : public TiXmlNode
{
public:
...
*/
class YXML_API TiXmlDocument : public TiXmlNode
{
public:
	...
	*/
	...
	/** Parse the given null terminated block of xml data. Passing in an encoding to this
	   ...
	   @return The location where parsing stopped. On error, this is the start point of the first level node that generated the error.
	*/
...
class YXML_API TiXmlParsingData
{
	friend class TiXmlDocument;
  public:
